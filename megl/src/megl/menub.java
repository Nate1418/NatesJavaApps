...
public class menub extends JFrame implements ActionListener{
	...
	menub(){
		...
		panel3 = new JPanel();
		panel3.setPreferredSize(new Dimension(500,450));
		...
		label4.setIcon(Tred);
		panel4 = new JPanel();
		panel4.setPreferredSize(new Dimension(500,450));
		...
		panel6 = new JPanel();
		panel6.setPreferredSize(new Dimension(500,450));
		...
		sukuna.setMnemonic(KeyEvent.VK_F); //Alt + F for File
		gojo.setMnemonic(KeyEvent.VK_E); //Alt + e for Edit
		kenjaku.setMnemonic(KeyEvent.VK_H); //Alt + h for Help
		
		dismantle.setMnemonic(KeyEvent.VK_S); //s for save
		fuga.setMnemonic(KeyEvent.VK_L); // l for Load
		DE.setMnemonic(KeyEvent.VK_X); // x for Exit 
		
		
		
		
		panel7 = new JPanel();
		panel7.setPreferredSize(new Dimension(500,450));
